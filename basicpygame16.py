...
#****เราอยากทำอะไร = ให้บอลหล่นมาจากด้านบนลงมา ถ้าชนกับตัว paddle ก็จะ +1 point แล้วก็จะสุ่มบอกมาใหม่เป็นloop**********
#***paddle เคลื่อนที่ได้แค่แนวนอนเท่านั้น********
#คือให้ลบ  if keys[pygame.K_UP] and paddle_rect.top > 0: #คำสั่งเปลี่ยนตำแหน่ง โดยใช้คีย์บอร์ด กดปุ่มขึ้น
    #         paddle_rect.y -= SPEED #คือการขยับpaddle ที่ตําแหน่ง y ทีละ 1
    # if keys[pygame.K_DOWN] and paddle_rect.bottom < SCREEN_H:
    #         paddle_rect.y += SPEED ทิ้ง
    
#ให้ ball สุ่มที่จะเกิดไปในแนวนอนเท่านั้น   
    # ball_rect.x = random.randint(0,SCREEN_W )


#ต่อยอดมาจาก basicpygame15.py
...
ball_rect.x =random.randint(0,SCREEN_W - 32) #คือไม่ให้มันสุ่มติดขอบเกินไป
ball_rect.y = 0
