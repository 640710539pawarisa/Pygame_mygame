#การใช้งานkeyboardในหน้าจอเกม ******
#รับค่าจากkeyboard*****

#****เราอยากทำอะไร = เราอยากเอาkeyboardเข้ามาทำงานในตัวเกมของเรา  **********88


#ต่อยอดมาจาก basicpygame9.py
...
while running:
    ...
    #เพิ่มการทํางานในหน้าจอเกมตรงนี้*****
        ...
        if keys[pygame.K_UP]:
            print("UP ARROW")
            paddle_rect.y -= 10 #คือการขยับpaddle ที่ตําแหน่ง y ทีละ 10
