#การกำหนดขอบเขตในหน้าจอเกม ************
#รับค่าจากkeyboard*****

# เพิ่ม paddle_rect.left>0 , paddle_rect.right <SCREEN_W คือมีขนาดจอน้อยกว่าหน้าจอเกม W คือ width ความกว้าง
# paddle_rect.top>0 , paddle_rect.bottom <SCREEN_H คือมีขนาดจอน้อยกว่าหน้าจอเกม H คือ height คือการกำหนดขอบเขตในหน้าจอเกม
#****เราอยากทำอะไร = เราอยากเพิ่มขอบเขตในหน้าจอเกม  **********88


#ต่อยอดมาจาก basicpygame12.py
...
while running:
    ...
    #ต้องทำนอกloopเพราะ ถ้ามันอยู่ในloopมันต้อง คลิกทีละอัน แต่ถ้าอยู่นอกloopมันจะทํางานตลอดเวลา
