#การแสดงข้อความ ในหน้าจอเกม(sysfont)*****
...
#ดึงฟอนต์ sysfont *****
font = pygame.font.get_fonts() #ดึงฟอนต์ sysfont
for font in font:
    print(font) #แสดงฟอนต์ทั้งหมดที่มีในเครื่องเรา
    
#แสดงข้อความในหน้าจอเกม  ****
#ตั้งค่าข้อความ และฟอนต์ ในหน้าจอเกม *****

# pygame.font.SysFont(name,size,bold,italic) #ดึงฟอนต์ sysfont
sys_font = pygame.font.SysFont("arial",30) #ดึงฟอนต์ sysfont
message_text = sys_font.render("Hello My Game",True,BLACK) #แสดงข้อความ ,เก็บไว้ในตัวแปร message_text
title_text = sys_font.render("My First Game",True,PURPULE) #แสดงข้อความ ,เก็บไว้ในตัวแปร title_text
