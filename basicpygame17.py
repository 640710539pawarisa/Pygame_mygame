...
#****เราอยากทำอะไร = ทำให้ ball เคลื่อนที่ โดยให้เช็คว่า ball น้อยกว่าขนาดความสูงหน้าจอ ยัง ?
#พุ่ง ball ไปข้างบน ใช้คําสั่งนี้ 
#ball_rect.y -= 5 เป็นค่าติดลบ

#พุ่ง ball ไปข้างล่าง ใช้คําสั่งนี้
#ball_rect.y += 5 เป็นค่าติดบวก

#สร้างตัวแปรให้เก็บค่าความเร็ว ball ใช้คําสั่งนี้
#BALL_SPEED = 5


#ต่อยอดมาจาก basicpygame16.py
